...
$course=$_POST['course'];
$sem=$_POST['sem'];
$ret=mysqli_query($con,"insert into courseenrolls(studentRegno,pincode,session,department,fees,course,semester) values('$studentregno','$pincode','$session','$dept','$fees','$course','$sem')");
if($ret)
{
...
<div class="form-group">
    ...
    <select class="form-control" name="fees" required="required">
...
{
?>
<option value="<?php echo htmlentities($row['id']);?>"><?php echo htmlentities($row['fees']);?></option>
<?php } ?>
