...
INSERT INTO `courseenrolls` (`id`, `studentRegno`, `pincode`, `session`, `department`, `fees`, `semester`, `course`, `enrollDate`) VALUES
...
INSERT INTO `fees` (`id`, `fees`, `creationDate`) VALUES
